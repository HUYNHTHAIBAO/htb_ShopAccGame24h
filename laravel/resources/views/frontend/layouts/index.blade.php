...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('frontend')}}/assets//storage/images/TL2fjkL38e_1610595242.jpg" type="image/x-icon">
    ...
    <link href="{{asset('frontend')}}/assets/css/socicon.css" rel="stylesheet" type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/bootstrap-social.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/font-awesome.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/simple-line-icons.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <!-- BEGIN: BASE PLUGINS  -->
    <link href="{{asset('frontend')}}/assets/css/magnific.css" rel="stylesheet" type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/cubeportfolio.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/owl.carousel.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
    <!-- END: BASE PLUGINS -->
    <!-- BEGIN: PAGE STYLES -->
    <link href="{{asset('frontend')}}/assets/css/bootstrap-datepicker.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/bootstrap-datepicker3.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/bootstrap-timepicker.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/bootstrap-datetimepicker.min.css"
          rel="stylesheet" type="text/css"/>
    <!-- END: PAGE STYLES -->
    <!-- BEGIN THEME STYLES -->
    <link href="{{asset('frontend')}}/assets/css/plugins.css" rel="stylesheet" type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/components.css" id="style_components" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('frontend')}}/assets/css/default.css" rel="stylesheet" id="style_theme"
          type="text/css"/>
    ...
    <link href="{{asset('frontend')}}/assets/css/style.css?v=165028560171931" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
    <script src="{{asset('frontend')}}/assets/js/jquery-2.1.0.min.js"></script>
    <script src="{{asset('frontend')}}/assets/js/bootstrap.min.js"></script>
    <script src="{{asset('frontend')}}/assets/js/owl.carousel.min.js"></script>
    <script src="{{asset('frontend')}}/assets/js/owl-carousel/slider.js"></script>
    <script src="{{asset('frontend')}}/assets/js/jquery-cookie/jquery.cookie.js"></script>
    <script src="{{asset('frontend')}}/assets/js/jquery-migrate.min.js" type="text/javascript"></script>
            ...
            <div class="c-navbar-wrapper clearfix">
                    ...
                    <div style="margin: 0px;display: inline-block">
                        <a href="/" class="c-logo"
                           alt="Shop bán nick game, acc game online avatar, đột kích – CF, liên minh huyền thoại lol , ngọc rồng, khí phách anh hùng - kpah giá rẻ, uy tín...">
                            <img height="35px"
                                 src="{{asset('frontend')}}/assets//storage/images/HYFiUkwC3Y_1560966469.jpg"
                ...
                <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold d-none hidden-xs hidden-sm">
                    <ul  class="nav navbar-nav c-theme-nav">
                        <li class="c-menu-type-classic"><a  rel=""  href="{{route('frontend.home.index')}}" class="c-link dropdown-toggle ">Trang chủ</a></li>
                        <li class="c-menu-type-classic"><a  rel=""  href="{{route('frontend.services.index')}}" class="c-link dropdown-toggle ">Dịch vụ game</a></li>
                        ...
                        <li class="c-menu-type-classic">
                            <a  rel=""  href="{{route('frontend.blogs.index')}}" class="c-link dropdown-toggle ">Blogs<span class="c-arrow c-toggler"></span></a>
                            <ul id="children-of-42" class="dropdown-menu c-menu-type-classic c-pull-left " >
                                ...
                                @foreach($blogs_huongdan as $key => $bloghd)
                                    <li class="c-menu-type-classic"><a  rel="" href="{{route('frontend.blog_details.index' , [$bloghd->slug])}}" class="">{{$bloghd->title}}</a></li>
...
<script src="{{asset('frontend')}}/assets/js/jquery.easing.min.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/wow.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/reveal-animate.js"
        type="text/javascript"></script>
<!-- END: CORE PLUGINS -->
<!-- BEGIN: LAYOUT PLUGINS -->
<script src="{{asset('frontend')}}/assets/js/magnific.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/jquery.cubeportfolio.min.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/jquery.counterup.min.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/jquery.waypoints.min.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/jquery.fancybox.min.js"></script>
<script src="{{asset('frontend')}}/assets/js/jquery.smooth-scroll.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/js.cookie.js" type="text/javascript"></script>
<!-- END: LAYOUT PLUGINS -->
<!-- BEGIN: THEME SCRIPTS -->
<script src="{{asset('frontend')}}/assets/js/components.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/app.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/bootbox.min.js" type="text/javascript"></script>
<script>
    $(document).ready(function () {
        App.init(); // init core
    });
...
<!-- END: THEME SCRIPTS -->
<!-- BEGIN: PAGE SCRIPTS -->
<script src="{{asset('frontend')}}/assets/js/moment.min.js" type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/daterangepicker.min.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/bootstrap-datepicker.min.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/bootstrap-timepicker.min.js"
        type="text/javascript"></script>
<script src={{asset('frontend')}}/assets/"js/bootstrap-datetimepicker.min.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/datepicker.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/jquery.mask.min.js"
        type="text/javascript"></script>
<script src="{{asset('frontend')}}/assets/js/common.js" type="text/javascript"></script>
